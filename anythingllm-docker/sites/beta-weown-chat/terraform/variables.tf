...
variable "ssh_key_fingerprints" {
  description = "List of DO SSH key fingerprints for droplet access (non-secret public identifiers). From the SHARED weown-tofu /infra/shared var TF_VAR_ssh_key_fingerprints (json list); team access is added post-boot via OPS_AUTHORIZED_KEYS."
  type        = list(string)
}
