...
5. **`anythingllm-docker/sites/s004.ccc.bot/`** — canonical reference site (already deployed); mirror its structure
...
2. **The s004 site** (`anythingllm-docker/sites/s004.ccc.bot/`) — what a working deployment of the same template looks like
...
- anythingllm-docker/sites/s004.ccc.bot/ (canonical reference)
