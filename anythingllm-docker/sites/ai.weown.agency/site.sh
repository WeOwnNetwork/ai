#!/usr/bin/env bash
# int-p01-anythingllm — convenience wrapper for site operations
#
...
cmd_restore() {
  ...
  if [[ -z "$backup_name" ]]; then
    ...
    echo "Example: $0 restore int-p01-anythingllm_backup_20260606_120000" >&2
    exit 1
  fi
...
cmd_help() {
  cat <<EOF
int-p01-anythingllm — site operations wrapper
