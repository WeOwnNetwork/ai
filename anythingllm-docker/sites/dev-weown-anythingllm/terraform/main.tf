# dev-weown-anythingllm-anythingllm - Main Infrastructure
# Managed by OpenTofu

resource "digitalocean_droplet" "anythingllm" {
  name       = "dev-weown-anythingllm-anythingllm"
  ...
  tags = ["dev-weown-anythingllm-anythingllm", "anythingllm", "ai", "weown-ai"]
...
resource "digitalocean_firewall" "anythingllm" {
  name        = "dev-weown-anythingllm-anythingllm-fw"
  ...
  tags = ["dev-weown-anythingllm-anythingllm"]
}
