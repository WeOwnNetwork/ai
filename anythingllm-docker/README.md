...
| `JWT_SECRET` | Random hex (`openssl rand -hex 32`) | **Yes** |
...
If migrating from the existing `ai/anythingllm` Helm chart:
...
|---------|---------|---------|
| `ai/anythingllm` | Kubernetes (Helm) | Original K8s deployment |
