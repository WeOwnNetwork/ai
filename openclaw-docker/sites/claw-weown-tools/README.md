# claw-weown-tools - OpenClaw AI Assistant Deployment
...
```bash
ssh root@<droplet-ip> 'tail /var/log/claw_weown_tools-rotation.log'
...
- **Local**: Stored on droplet at `/opt/claw_weown_tools/backups/`
...
./scripts/restore.sh root@your-droplet-ip claw-weown-tools_backup_20260115_120000
...
2. **Transfer to new droplet**:
   ...
   ```bash
   scp openclaw-storage-backup.tar.gz root@new-droplet-ip:/opt/claw_weown_tools/backups/
