...
if [[ $# -eq 2 ]]; then
  ...
  echo ""
  echo "Examples:"
  echo "  $0 root@143.198.xxx.xxx s004-anythingllm_backup_20260115_120000"
  echo "  $0 s004-anythingllm_backup_20260115_120000"
  echo ""
  echo "Note: Run via Infisical on the droplet:"
  echo "  ssh root@<host> 'cd /opt/s004anythingllm && infisical run --projectId= --env=prod -- ./restore.sh ...'"
  exit 1
fi
